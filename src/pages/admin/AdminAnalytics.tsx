...
export const AdminAnalytics: React.FC = () => {
  ...
  const trendData = [
    { day: 'Mon', revenue: Math.round(totalPlatformRevenue * 0.11 + 45), orders: 28 },
    { day: 'Tue', revenue: Math.round(totalPlatformRevenue * 0.13 + 60), orders: 34 },
    { day: 'Wed', revenue: Math.round(totalPlatformRevenue * 0.15 + 75), orders: 42 },
    { day: 'Thu', revenue: Math.round(totalPlatformRevenue * 0.16 + 85), orders: 48 },
    { day: 'Fri', revenue: Math.round(totalPlatformRevenue * 0.22 + 110), orders: 65 },
    { day: 'Sat', revenue: Math.round(totalPlatformRevenue * 0.28 + 140), orders: 82 },
    { day: 'Sun', revenue: Math.round(totalPlatformRevenue * 0.25 + 125), orders: 74 },
  ];
