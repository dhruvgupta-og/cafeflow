        ...
        <div className="p-6 space-y-6">
          ...
          <div className="pt-2 flex flex-wrap items-center justify-between gap-3 border-t border-stone-800">
            ...
            <button
              ...
              className="px-5 py-2 rounded-xl bg-amber-500 hover:bg-amber-400 text-stone-950 text-xs font-bold flex items-center gap-1.5 shadow transition"
            >
              Launch Cafe Dashboard <ArrowRight className="w-3.5 h-3.5" />
            </button>
          </div>
        </div>
      </div>
